...
export default function CategoryPreviews() {
  return (
    <div className="mb-16 flex w-full items-stretch space-x-4">
      ...
      <div className="flex flex-col w-full space-y-4">
        <Link href="/runes" passHref>
          <a className="h-full bg-white dark:bg-dark rounded-lg p-4 relative overflow-hidden">
            <img
        ...
        <Link href="/champions" passHref>
          <a className="h-full bg-white dark:bg-black rounded-lg p-4 relative overflow-hidden">
            <img
