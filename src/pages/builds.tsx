...
export default function BuildsPage({ builds } : {builds: (IBuildStats & {isKeystone: boolean, isSmallRune: boolean})[]}) {
  ...
  }, [router.query.filterId, router.query.filterName, router.query.filterType]);
    ...
    () =>
      setFilteredBuilds(
        builds.filter((b) => {
          ...
          if (
            itemFilter &&
            ![b.item1Id, b.item2Id, b.item3Id].includes(itemFilter.id)
          ) {
            return false;
          }
          ...
          if (
            ...
            favourites.find((f) => {
              if (f.type === "CHAMPION") {
                ...
                return [b.item1Id, b.item2Id, b.item3Id].includes(f.id);
              }
